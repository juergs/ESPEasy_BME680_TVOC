...
For FHEM slink transmission feature via UDP, some additional Perl modules are needed. Grab them: [here](https://github.com/herrmannj/AirQuality/tree/master/FHEM)
...
<h2>Pictures</h2>
<br>
Comparison between BSEC and TVOC. TVOC's baseline is at the moment not so effective as BSEC. Filtering smoothes measured values, but not so effective on fast value changes. 
